...
Chartes entre la ville d’Ivry-sur-Seine, l’Etablissement Public Territorial Grand-Orly Seine Bièvre et le prestataire",
  ...
  decision.save!
   ...
   url = "https://static.actu.fr/uploads/2018/03/DSC_0474-854x570.jpg"
  decision = Decision.new(
    title: "Entretien du patrimoine",
    category: "Logement",
    description: "Participation de la Ville au budget 2018 pour l’entretien du patrimoine et la réhabilitation des cités
Subvention de 1 845 000 €",
    result: 0,
    minutes: "PREND ACTE du rapport d’utilisation de la dotation de solidarité urbaine et de cohésion sociale (DSUCS) pour l’année 2017.
    ",
    council_date: Date.new(2019, 03, 12),
    town_id: Town.first.id
  )
